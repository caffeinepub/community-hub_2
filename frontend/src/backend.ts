...
export class Backend implements backendInterface {
    ...
    async createFreeStuffPost(arg0: string, arg1: string, arg2: FreeStuffCategory, arg3: string, arg4: string, arg5: Array<string>, arg6: Time | null, arg7: string | null, arg8: string | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createFreeStuffPost(arg0, arg1, to_candid_FreeStuffCategory_n10(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5, to_candid_opt_n12(this._uploadFile, this._downloadFile, arg6), to_candid_opt_n13(this._uploadFile, this._downloadFile, arg7), to_candid_opt_n13(this._uploadFile, this._downloadFile, arg8));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteFreeStuffPost(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteFreeStuffPost(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFreeStuffPosts(arg0: FreeStuffCategory | null, arg1: string | null, arg2: string | null): Promise<Array<FreeStuffPost>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFreeStuffPosts(to_candid_opt_n21(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n13(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n13(this._uploadFile, this._downloadFile, arg2));
    ...
    async likeFreeStuffPost(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.likeFreeStuffPost(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateFreeStuffAvailability(arg0: bigint, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateFreeStuffAvailability(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async verifyFreeStuffPost(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.verifyFreeStuffPost(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_FreeStuffCategory_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FreeStuffCategory): FreeStuffCategory {
    return from_candid_variant_n28(_uploadFile, _downloadFile, value);
}
function from_candid_FreeStuffPost_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FreeStuffPost): FreeStuffPost {
...
function from_candid_record_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        author: value.author,
        likes: value.likes,
        expirationTime: record_opt_to_undefined(from_candid_opt_n26(_uploadFile, _downloadFile, value.expirationTime)),
        timestamp: value.timestamp,
        category: from_candid_FreeStuffCategory_n27(_uploadFile, _downloadFile, value.category),
        proof: record_opt_to_undefined(from_candid_opt_n25(_uploadFile, _downloadFile, value.proof))
    };
}
...
function from_candid_variant_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "tipsAndTricks" in value ? FreeStuffCategory.tipsAndTricks : "freeGamePass" in value ? FreeStuffCategory.freeGamePass : "promoCode" in value ? FreeStuffCategory.promoCode : "freeUGC" in value ? FreeStuffCategory.freeUGC : "general" in value ? FreeStuffCategory.general : value;
}
function from_candid_vec_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_FreeStuffPost>): Array<FreeStuffPost> {
    return value.map((x)=>from_candid_FreeStuffPost_n23(_uploadFile, _downloadFile, x));
}
...
function to_candid_FreeStuffCategory_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FreeStuffCategory): _FreeStuffCategory {
...
function to_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FreeStuffCategory | null): [] | [_FreeStuffCategory] {
    return value === null ? candid_none() : candid_some(to_candid_FreeStuffCategory_n10(_uploadFile, _downloadFile, value));
}
...
function to_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FreeStuffCategory): {
    tipsAndTricks: null;
} | {
    freeGamePass: null;
} | {
    ...
    return value == FreeStuffCategory.tipsAndTricks ? {
        tipsAndTricks: null
    } : value == FreeStuffCategory.freeGamePass ? {
        freeGamePass: null
    } : value == FreeStuffCategory.promoCode ? {
        promoCode: null
    } : value == FreeStuffCategory.freeUGC ? {
        freeUGC: null
    } : value == FreeStuffCategory.general ? {
        general: null
    } : value;
}
